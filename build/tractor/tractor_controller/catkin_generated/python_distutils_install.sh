...
echo_and_run cd "/home/ducthang/agribot2/src/tractor/tractor_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ducthang/agribot2/src/tractor/tractor_controller/setup.py" \
     \
    build --build-base "/home/ducthang/agribot2/build/tractor/tractor_controller" \
    install \
    --root="${DESTDIR-/}" \
